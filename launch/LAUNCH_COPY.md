<!-- Resolved launch copy.

Generated from publications/adoption-without-confidence/publication/LAUNCH_KIT.md
with the two placeholder tokens replaced by their real URLs.

The copy in the package is left byte-identical on purpose: it is covered by
MANIFEST.sha256, which must keep verifying 58/58 against the released v3.1.0
package. This file is the version to actually post from.
-->
...
https://imaginationapplied.ai/publications/adoption-without-confidence/

https://github.com/jpenzell/imagination-applied
...
4. Placeholder links: already resolved in this file.
